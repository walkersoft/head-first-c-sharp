...
namespace WPFGoFish
{
    public class Game : INotifyPropertyChanged
    {
        ...
        /*public Game(string playerName, IEnumerable<string> opponentNames) //, TextBox textBoxOnForm)
        {
            ...
            players.Add(new Player(playerName, random, this)); //, textBoxOnForm));
            foreach (string player in opponentNames)
                players.Add(new Player(player, random, this)); //, textBoxOnForm));
        ...
        public void PlayOneRound(int selectedPlayerCard)
        {
            ...
            for (int i = 0; i < players.Count; i++)
            {
                ...
                {
                    AddProgress(players[i].Name + " drew a hand.");
                    int card = 1;
            ...
            if (stock.Count == 0)
            {
                this.AddProgress("The stock is out of cards. Game Over!");
        ...
        public void StartGame()
        {
            ...
            players.Add(new Player("Lucy", random, this));
            Deal();
            players[0].SortHand();
            Hand.Clear();
            foreach (String cardName in GetPlayerCardNames())
